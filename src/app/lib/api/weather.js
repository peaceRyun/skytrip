...
const CURR_URL = 'https://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtNcst';
...
export async function fetchCurrentWeather({ nx, ny, baseDate, baseTime }) {
